package ua.goit.gojava.module_9.main.java;

public class Runner {
    public static void main(String[] args) {
        EnglishCesar module9 = new EnglishCesar();
        ...
        String encryptedText = module9.encrypt(text, 5);

        System.out.println("THE ENCRYPTED TEXT IS: \n" + encryptedText);

        System.out.println();

        String decryptedText = module9.decrypt(encryptedText, 5);
